...
public class MainActivity extends AppCompatActivity implements OnInitListener{
	...
	private static List<Screen> createScreenObjects() {
		...
		Screen mobileRecharge = new Screen(rechargebase, Arrays.asList(new MainKeyword("Prepaid", "Postpaid", Collections.singletonList("")), new MainKeyword("Enter", "", Collections.singletonList("Proceed"))), Arrays.asList("Prepaid", "Postpaid", "Bill", "Opostpaid", "Oprepaid"), 3, 0, Arrays.asList("प्रीपेड रिचार्ज के लिए यहां क्लिक करें", "कृपया ऊपर दिए गए बॉक्स में अपना मोबाइल नंबर दर्ज करें और नीचे दी गई proceed पर क्लिक करें।"), 101);
